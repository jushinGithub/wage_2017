  ...
  $(function(){
	 //设置日期
	 setMonthDate();
	 $("#exportBtn").bind('click', {title:'计件人员工资汇总表',pojo:'MonthSalary' },exportExcel);
			...
			success:function(data){
			  ...
			  $('#dg').datagrid({
					...
					frozenColumns:[[{field:'orgName',  title:'班组', width:60,halign:'center', align:'left' },
							        ...
							        {field:'time',     title:'工时', hidden:true,width:60,halign:'center', align:'center'},
							        {field:'grade',    title:'分值', hidden:true,width:60,halign:'center', align:'center'},
							        {field:'sumGrade', title:'总分值',hidden:true,width:60,halign:'center', align:'center'},
			  	...
			  	//组合表头
				compHeader = '<tr><th rowspan="2">班组</th><th rowspan="2" >计件工资</th>'
				...
				$("#printBtn").bind('click',{title: '计件人员工资汇总表',compHeader:compHeader,rowNum:20},printData);
			}
		});
	...
	function querySalary(){
		...
		$.ajax({
			...
			data:'month='+date+'&isPiece=√&shop='+shop,
			cache:false,
