...
<html>
  <head>
	...
	<script type="text/javascript" src="page/salary/report/org_salary_time.js"></script>
  ...
  <body>
    <div class="easyui-layout" style="width:100%;height:100%;">
		...
		<div data-options="region:'center'" >
			...
			<table id="dg" class="easyui-datagrid" title="计时人员工资汇总表" style="width:auto;height:95%"></table>
		</div><!--grid  -->
	</div>
  </body>
