			...
			success:function(groupName){
				if(groupName.length > 0){ 
			        ...
			        for(var i=0; i<groupName.length; i++){
			        	...
			        	//secondPart.push({field:'comp'+groupName[i], title:'完工数', hidden:true, width:50,halign:'center',align:'right',editor:{type:'numberbox'}});
			        }
			        
			        firstPart.push({field:'sumSlFetch',    title:'领用数合计',hidden:false, halign:'center',align:'right', rowspan:2});
			        //firstPart.push({field:'sumSlComp',     title:'完工数合计',hidden:true, halign:'center',align:'right', rowspan:2});
