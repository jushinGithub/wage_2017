...
<html>
  <head>
	...
	<script type="text/javascript" src="page/salary/salary_piece.js"></script>
  ...
  <body>
    <div class="easyui-layout" style="width:100%;height:100%;">
		...
		<div data-options="region:'center'"  >
		     <div >
		      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
		                    班组:<input id="orgId" class="easyui-combotree" value="21201" data-options="url:'getOrgTreeNodes.action?pid=1',method:'get',onCheck:querySalary" multiple style="width:150px;">
	    	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<table id="dg" class="easyui-datagrid" title="各班组计件工资表" style="width:100%;height:92%" ></table>
		</div><!--grid  -->
	</div>
  </body>
